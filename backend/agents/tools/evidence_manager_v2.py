...
# Note: Import models and deps from backend when running in full application
# from backend.models import Evidence, Finding, User  
# from backend.deps import get_settings

# Standalone configuration for development
class Settings:
    def __init__(self):
        self.evidence_vault_path = "evidence"
